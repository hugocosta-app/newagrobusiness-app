...
login_manager.login_view = 'auth.login' # Where to redirect users if they need to log in
...
def create_app(config_class=Config):
    ...
    with app.app_context():
        ...
        # Create a default admin user on first run (important for initial access)
